...
public class NeFrameConfiguration {	
	...
	public static void setFps(long fps) {
		NeFrameConfiguration.fps = fps;
		loadFpsTime();
	}
	
	public static void setHertz(long hertz) {
		NeFrameConfiguration.hertz = hertz;
		loadHertzTime();
	}
	...
	private static void loadFpsTime() {
		fpsTime = NeConstantsRegistry.SECOND_IN_NANO / NeFrameConfiguration.getFps();
	}
	
	private static void loadHertzTime() {
		hertzTime = NeConstantsRegistry.SECOND_IN_NANO / NeFrameConfiguration.getHertz();
	}
